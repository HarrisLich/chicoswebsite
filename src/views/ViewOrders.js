...
export default function ViewOrders() {
    ...
    React.useEffect(() => {
        axios.post("https://chico-backend-857ad46e3125.herokuapp.com/api/orders", {startIndex: 0}).then((res) => {
            setOrders(res.data)
        })
    }, [])
                        ...
                        return (
                            <div className="flex py-4 relative text-white flex-col w-full border-b border-1 border-zinc-900">
                                ...
                                <div className="absolute right-1 bottom-1">
                                    <button onClick={(e) => {
                                        e.preventDefault()
                                        axios.delete("https://chico-backend-857ad46e3125.herokuapp.com/api/deleteForm", {
                                            data: {
                                                val: element._id
                                            }
