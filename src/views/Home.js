    ...
    if (user && user === "chico") {
        ...
        return (
            <div className="w-full h-full flex flex-col items-center justify-center font-[pt]" style={{ height: "calc(100vh)" }}>
                ...
                <div className="absolute rounded-full flex items-center justify-center text-center text-xs md:text-base px-8 py-2 bg-white text-lg -translate-x-[50%] md:top-5 top-20 left-[50%] text-black">
