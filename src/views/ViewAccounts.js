...
export default function ViewAccount() {
    ...
    React.useEffect(() => {
        axios.post("https://chicos-backend.netlify.app:5001/api/accounts").then((res) => {
    ...
    const removeRefferal = (e, elem, event)=>{
        ...
        axios.delete("https://chicos-backend.netlify.app:5001/api/deleteRefferal", {
            data: {
                user: elem._id,
                reffered: e
            }
                        ...
                        return(
                            <div className="flex py-4 relative text-white flex-col w-full border-b border-1 border-zinc-900">
                                ...
                                <button onClick={(e)=>{
                                    ...
                                    axios.post("https://chicos-backend.netlify.app:5001/api/updateAccount", elem)
                                    window.location.reload(true)
