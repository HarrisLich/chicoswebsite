...
export default function ViewAccount() {
    ...
    React.useEffect(() => {
        axios.post("https://chicos-backend-production.up.railway.app/api/accounts").then((res) => {
    ...
    const removeRefferal = (e, elem, event) => {
        ...
        axios.delete("https://chicos-backend-production.up.railway.app/api/deleteRefferal", {
            data: {
                user: elem._id,
                reffered: e
            }
    ...
    const markAccount = (event, elem) => {
        ...
        axios.post("https://chicos-backend-production.up.railway.app/api/updateAccount", elem).then((res) => {
            console.log(res)
            window.location.reload(true)
        })
    ...
    const showForm = (event, elem) => {
        ...
        axios.post("https://chicos-backend-production.up.railway.app/api/findForm", { username: elem.username }).then((res) => {
            console.log(res)
            setForm(res.data)
        })
    }
    ...
    const deleteAccount = (event, elem) => {
        event.preventDefault()
        axios.delete("https://chicos-backend-production.up.railway.app/api/deleteAccount", {
            data: {
